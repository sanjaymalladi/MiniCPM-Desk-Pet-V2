...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      aboutFooter: "MiniCPM Desk Pet is open source. Built with care by the community.",
    ...
    zh: {
      ...
      aboutFooter: "MiniCPM Desk Pet 是开源项目 · 与社区一起打造。",
    ...
    "zh-TW": {
      ...
      aboutFooter: "MiniCPM Desk Pet 是開源專案 · 和社群一起做出來的。",
    ...
    ko: {
      ...
      aboutFooter: "MiniCPM Desk Pet는 오픈 소스 · 커뮤니티와 함께 만듭니다.",
    ...
    ja: {
      ...
      aboutFooter: "MiniCPM Desk Pet はオープンソース。コミュニティと一緒に作っています。",
