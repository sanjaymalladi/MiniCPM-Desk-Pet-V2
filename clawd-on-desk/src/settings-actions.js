...
const updateRegistry = {
  ...
  attentionEnabled: requireBoolean("attentionEnabled"),
  attentionVisionEnabled: requireBoolean("attentionVisionEnabled"),
  attentionDistractionMinutes: requireIntegerInRange("attentionDistractionMinutes", 1, 60),
